...
export function buildMapper(config) {
  ...
  return function mapEvent(ev) {
    ...
    if (titleMatches(ev.summaryLower, ["shower", "ducha", "skincare", "skin care", "hair", "pelo", "self care", "self-care", "autocuidado", "bath", "baño"])) {
      return { areaId: "self_care", alsoAreas: [], silentInsight: false };
    }
